...
<table>
 ...
 <table>
        ...
        <tr>
            <td>Project will start Dec 22, 2023 6:00 AM, must end by Dec 23, 2023 6:00 AM</td>
        </tr>
        <tr>
            <td>Checker will be released at Dec 22, 2023 12:00 PM</td>
        </tr>
        <tr>
...
<p> writing Puppet code for your infrastructure requires an investment of time and energy, but in the long term, it is for sure a must-have.</p>
...
```
You do <b>not</b> need to attempt to upgrade versions. This project is simply a set of tasks to familiarize you with the basic level syntax which is virtually identical in newer versions of Puppet.
